<?php
// FROM HASH: f91373b61a5a38b908362023fdc9d888
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['album']['thumbnail_date']) {
		$__finalCompiled .= '
		<div class="contentRow-figure contentRow-figure--fixedMedium"><a href="' . $__templater->func('link', array('media/albums', $__vars['album'], ), true) . '"><img src="' . $__templater->escape($__vars['album']['thumbnail_url']) . '" alt="' . $__templater->escape($__vars['album']['title']) . '" /></a></div>
	';
	}
	$__finalCompiled .= '
