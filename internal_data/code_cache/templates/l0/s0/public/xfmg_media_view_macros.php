<?php
// FROM HASH: 95d02c53238bdf5a5b943471910ca694
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['mediaItem']['media_type'] == 'image') {
		...
		$__vars['imageHtml'] = $__templater->preEscaped('
				<img src="' . $__templater->func('link', array('media/full', $__vars['mediaItem'], array('d' => ($__vars['mediaItem']['last_edit_date'] ?: null), ), ), true) . '" alt="' . $__templater->escape($__vars['mediaItem']['title']) . '" class="js-mediaImage" />
			');
		$__finalCompiled .= '
			';
		if ($__vars['linkMedia']) {
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if (!$__templater->test($__vars['filmStripParams']['mediaItems'], 'empty', array())) {
			...
			<div class="block-outer-middle">
				<div class="itemList itemList--strip js-filmStrip">
					<a data-xf-click="inserter" data-replace=".js-filmStrip"
						href="' . $__templater->func('link', array('media/film-strip-jump', $__vars['mediaItem'], array('direction' => 'prev', 'jump_from_id' => $__vars['filmStripParams']['firstItem']['media_id'], ), ), true) . '"
		...
		$__finalCompiled .= '
					...
					<a data-xf-click="inserter" data-replace=".js-filmStrip"
						href="' . $__templater->func('link', array('media/film-strip-jump', $__vars['mediaItem'], array('direction' => 'next', 'jump_from_id' => $__vars['filmStripParams']['lastItem']['media_id'], ), ), true) . '"
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['mediaItem']['media_type'] == 'image') {
		$__compilerTemp3 .= '
			...
			'text' => '[IMG]' . $__templater->func('link', array('canonical:media/full', $__vars['mediaItem'], ), false) . '[/IMG]',
		), $__vars) . '
									';
	} else if ($__vars['mediaItem']['media_type'] == 'embed') {
		$__compilerTemp3 .= '
	...
	if ($__vars['mediaItem']['thumbnail_date']) {
		$__compilerTemp3 .= '
			...
			'text' => '[URL="' . $__templater->func('link', array('canonical:media', $__vars['mediaItem'], ), false) . '"][IMG]' . $__templater->method($__vars['mediaItem'], 'getThumbnailUrl', array(true, )) . '[/IMG][/URL]',
		), $__vars) . '
								';
	}
	$__compilerTemp3 .= '
