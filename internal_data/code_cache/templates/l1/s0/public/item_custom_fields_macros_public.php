<?php
// FROM HASH: 92e7d236c4199c56e8d16f076a65689f
return array(
...
';
	...
	if ($__templater->isTraversable($__compilerTemp1)) {
		...
		';
			...
			';
				if ($__vars['checkLabel'] == '1') {
					$__finalCompiled .= '
			';
					$__vars['label'] = 'Custom fields';
					$__finalCompiled .= '
				';
				} else {
					$__finalCompiled .= '
			...
			';
				...
				$__finalCompiled .= $__templater->formCheckBoxRow(array(
					...
					'checked' => ($__vars['set'][$__vars['fieldDefinition']['field_id']] ? true : false),
					'_dependent' => array('
