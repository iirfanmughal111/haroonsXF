<?php
// FROM HASH: e70724c6fbf1bf338328b0ed0f583f3f
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['mediaItem']['has_thumbnail']) {
		$__finalCompiled .= '
		<div class="contentRow-figure contentRow-figure--fixedMedium"><a href="' . $__templater->func('link', array('media', $__vars['mediaItem'], ), true) . '"><img src="' . $__templater->escape($__vars['mediaItem']['current_thumbnail_url']) . '" alt="' . $__templater->escape($__vars['mediaItem']['title']) . '" /></a></div>
	';
	}
	$__finalCompiled .= '
