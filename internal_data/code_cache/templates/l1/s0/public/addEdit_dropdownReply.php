<?php
// FROM HASH: e9c8c4f10555745763de50b080f79e5d
return array(
...
<div class="block">
  ';
    ...
    ', array(
			'action' => $__templater->func('link', array('dropdownreply/save', ), false),
			'ajax' => 'true',
    ...
    ' . $__templater->form('
      <!-- ' . $__templater->escape($__vars['xf']['visitor']['is_moderator']) . ' -->
    ...
    ', array(
			'action' => $__templater->func('link', array('dropdownreply/save', $__vars['thread'], ), false),
			'ajax' => 'true',
			'class' => 'block-container',
			'novalidate' => 'novalidate',
		)) . '
