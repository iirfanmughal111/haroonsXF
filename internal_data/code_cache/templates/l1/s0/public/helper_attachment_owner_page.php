<?php
// FROM HASH: 8d67fc8b25ea7d564874ac285b08437b
return array(
...
' . $__templater->button('', array(
		'href' => $__templater->func('link', array('attachments/upload', null, array('type' => 'bh_ownerpage', 'context' => $__vars['attachmentData']['context'], 'hash' => $__vars['attachmentData']['hash'], ), ), false),
	...
	' . $__templater->formHiddenVal('attachment_hash', $__vars['attachmentData']['hash'], array(
								...
								' . $__templater->formHiddenVal('attachment_hash_combined', $__templater->filter(array('type' => 'bh_item', 'context' => $__vars['attachmentData']['context'], 'hash' => $__vars['attachmentData']['hash'], ), array(array('json', array()),), false), array(
	)) . '
';
