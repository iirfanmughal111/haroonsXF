<?php
// FROM HASH: e27bf6501fa0b62bec206410051cd014
return array(
  ...
  ';
    ...
    ';
			...
			if ($__vars['escrow']['Thread']) {
				$__compilerTemp1[] = array(
					'_type' => 'cell',
					'html' => ' ' . $__templater->func('snippet', array($__vars['escrow']['Thread']['title'], 35, array('stripBbCode' => true, ), ), true) . '  ',
				);
				$__compilerTemp1[] = array(
					'_type' => 'cell',
					'html' => ' ' . $__templater->escape($__vars['escrow']['Thread']['User']['username']) . ' ',
				);
				$__compilerTemp1[] = array(
					'_type' => 'cell',
					'html' => ' ' . $__templater->escape($__vars['escrow']['User']['username']) . ' ',
				);
				$__compilerTemp1[] = array(
					'_type' => 'cell',
					'html' => $__templater->escape($__vars['escrow']['escrow_amount']),
				);
				$__compilerTemp1[] = array(
					'_type' => 'cell',
					'html' => '
