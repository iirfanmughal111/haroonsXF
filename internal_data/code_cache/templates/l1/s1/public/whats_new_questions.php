<?php
// FROM HASH: 05ab2aec78e8ef967c1e7ee1a0f5ab4b
return array(
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	array(
		...
		'label' => 'Questions in which you\'ve answered',
		'_type' => 'option',
	),
	array(
		'name' => 'started',
		'selected' => $__vars['findNew']['filters']['started'],
		'label' => 'Questions you\'ve started',
		'_type' => 'option',
	),
	array(
		'name' => 'unanswered',
...
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	';
		...
		if ($__vars['xf']['visitor']['user_id'] AND ($__vars['findNew']['filters']['unread'] AND ($__templater->func('count', array($__vars['findNew']['filters'], ), false) == 1))) {
			$__finalCompiled .= '
				' . 'You have no unread questions. You may <a href="' . $__templater->func('link', array($__vars['latestRoute'], null, array('skip' => 1, ), ), true) . '" rel="nofollow">view all latest questions</a> instead.' . '
			';
		} else {
			$__finalCompiled .= '
				' . 'No results found.' . '
...
{
	$__finalCompiled = '';
	$__templater->pageParams['pageTitle'] = $__templater->preEscaped('New Questions');
	$__templater->pageParams['pageNumber'] = $__vars['page'];
	$__finalCompiled .= '

';
	$__compilerTemp1 = $__vars;
	$__compilerTemp1['pageSelected'] = $__templater->preEscaped('fs_questions');
...
<div class="block" data-xf-init="' . ($__vars['canInlineMod'] ? 'inline-mod' : '') . '" data-type="thread" data-href="' . $__templater->func('link', array('inline-mod', ), true) . '">
	...
	<div class="block-container">
		...
		'findNew' => $__vars['findNew'],
		'rerunRoute' => 'whats-new/questions',
		'rerunData' => $__vars['findNew'],
		'filterRoute' => 'whats-new/questions',
	), $__vars) . '

		' . $__templater->callMacro(null, 'results', array(
		'findNew' => $__vars['findNew'],
		'threads' => $__vars['threads'],
		'latestRoute' => 'whats-new/questions',
	), $__vars) . '
	</div>
