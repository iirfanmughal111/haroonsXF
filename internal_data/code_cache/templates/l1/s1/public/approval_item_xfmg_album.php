<?php
// FROM HASH: a7a6b9cfe77276f9fad1c02b43d73e83
return array(
'code' => function($__templater, array $__vars, $__extensions = null)
{
	...
	if ($__vars['content']['thumbnail_date']) {
		...
		<div class="album-container">
			<a href="' . $__templater->func('link', array('media/albums', $__vars['content'], ), true) . '">
				<img src="' . $__templater->escape($__vars['content']['thumbnail_url']) . '" />
			</a>
		</div>
	';
	}
	...
	<h4 class="message-title"><a href="' . $__templater->func('link', array('album', $__vars['content'], ), true) . '">' . $__templater->escape($__vars['content']['title']) . '</a></h4>
	' . $__compilerTemp1 . '
	' . $__compilerTemp2 . '
');
	$__finalCompiled .= '
