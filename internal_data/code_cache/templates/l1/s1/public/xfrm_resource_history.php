			...
			if ($__templater->method($__vars['resource'], 'canViewTeamMembers', array()) AND ($__vars['version']['team_user_id'] AND ($__vars['version']['team_user_id'] != $__vars['resource']['user_id']))) {
				$__compilerTemp4 .= '
								<a role="button"
									...
									title="' . 'Posted by' . $__vars['xf']['language']['label_separator'] . ' ' . ($__vars['version']['TeamUser'] ? $__templater->escape($__vars['version']['TeamUser']['username']) : $__templater->escape($__vars['version']['team_username'])) . '">' . trim('
