<?php
// FROM HASH: a36459ed6fa3ebd0a86c3013e7b787e3
return array(
...
';
	if ($__vars['content']['thumbnail_date']) {
		$__finalCompiled .= '
	<div class="contentRow-figure contentRow-figure--fixedMedium"><a href="' . $__templater->func('link', array('media/albums', $__vars['content'], ), true) . '"><img src="' . $__templater->escape($__vars['content']['thumbnail_url']) . '" alt="' . $__templater->escape($__vars['content']['title']) . '" /></a></div>
';
	}
	$__finalCompiled .= '
