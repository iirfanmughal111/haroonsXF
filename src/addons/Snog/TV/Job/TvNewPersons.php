...
class TvNewPersons extends \XF\Job\AbstractJob
{
	...
	public function run($maxRunTime)
	{
		...
		foreach ($personsData as $key => $personData)
		{
			...
			$person = $em->find('Snog\TV:Person', $personData['id']);
			if ($person)
			{
				continue;
			}
	...
	{
		/** @var \Snog\TV\Service\Person\Creator $creator */
		$creator = $this->app->service('Snog\TV:Person\Creator', $personData['id']);
	...
	protected function finalizePersonCreate(\Snog\TV\Service\Person\Creator $creator)
	{
