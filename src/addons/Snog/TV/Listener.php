...
class Listener
{
	...
	public static function nodeEntityPostDelete(Entity $entity)
	{
		...
		/** @var \Snog\TV\Entity\TVForum $entity */

		$tvNode = $entity->finder('Snog\TV:TVForum')->where('node_id', $entity->node_id)->fetchOne();
		if ($tvNode)
		{
			$tvNode->delete();
		}
	...
	public static function forumEntityPostDelete(Entity $entity)
	{
		...
		$entity->db()->delete('xf_snog_tv_forum', 'node_id = ?', $entity->node_id);
	}
