...
class Company extends Entity
{
	...
	protected function _postDelete()
	{
		if ($this->logo_path)
		{
			...
			$imageService = $this->app()->service('Snog\Movies:Company\Image', $this);
    ...
    {
        $structure->table = 'xf_snog_movies_company';
        $structure->shortName = 'Snog\Movies:Company';
