...
class Trophy extends XFCP_Trophy
{
    ...
    protected function thuiTrophyCategoryAddEdit(TrophyCategory $category)
    {
        ...
        return $this->view('ThemeHouse\UserImprovements:TrophyCategory\Edit', 'thuserimprovements_trophy_category_edit', $viewParams);
    }
    ...
    public function actionTHUIReward()
    {
        ...
        return $this->view('ThemeHouse\UserImprovements:Trophy\Reward', 'thuserimprovements_reward_trophy', $viewParams);
    }
