...
class Setup extends AbstractSetup
{
	...
	public function upgrade902010010Step1(array $stepParams)
	{
		...
		return $this->entityColumnsToJson(
			'XFMG:Album', ['like_users'], $position, $stepParams);
	}
	...
	public function upgrade902010010Step2(array $stepParams)
	{
		...
		return $this->entityColumnsToJson(
			'XFMG:Category', ['field_cache', 'allowed_types', 'breadcrumb_data'], $position, $stepParams
		);
	}
	...
	public function upgrade902010010Step3(array $stepParams)
	{
		...
		return $this->entityColumnsToJson('XFMG:Comment', ['like_users'], $position, $stepParams);
	}
	...
	public function upgrade902010010Step4(array $stepParams)
	{
		...
		return $this->entityColumnsToJson(
			'XFMG:MediaItem', ['like_users', 'custom_fields', 'tags'], $position, $stepParams
		);
	}
	...
	public function upgrade902010010Step6(array $stepParams)
	{
		...
		return $this->entityColumnsToJson('XFMG:TranscodeQueue', ['queue_data'], $position, $stepParams);
	}
