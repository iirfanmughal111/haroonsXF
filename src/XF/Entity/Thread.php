...
class Thread extends Entity implements LinkableInterface
{
	...
	public function canPreview(&$error = null)
	{
		...
		return ($this->discussion_type != 'redirect'
			&& $this->first_post_id
	...
	public static function getStructure(Structure $structure)
	{
		...
		$structure->behaviors = [
			...
			'XF:ContentVotableContainer' => [
				...
				'childIds' => function ($thread) {
					return $thread->post_ids;
				},
			...
			'XF:CustomFieldsHolder' => [
				...
				'getAllowedFields' => function ($thread) {
					return $thread->Forum ? $thread->Forum->field_cache : [];
				}
			]
		];
		$structure->getters = [
